...
// Данный метод обслуживает обработку изменения всех трех субконто

	БухгалтерскийУчетКлиентСервер.УстановитьСвойстваСубконтоШапкиПриИзмененииСубконто(
		ЭтаФорма, Объект, Число(СтрЗаменить(Элемент.Имя, "Субконто", "")), ПараметрыУстановкиСвойствСубконто());
