// МассивЭлементов   - массив произвольных элементов, образующих комбинации. Произвольный.
...
// Возвращаемое значение - массив фиксированных массив всевозможных перестановок
