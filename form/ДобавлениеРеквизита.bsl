...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Обработчик событий
	ПолеВвода.УстановитьДействие("ПриИзменении", "ВыполнитьДействиеПриИзмененииДанных");

	// Добавление реквизита кратко
	РеквизитФормы = Новый РеквизитФормы("ск_АвтоматическиРассчитыватьСуммуНДС",
		Новый ОписаниеТипов("Булево"), "<Путь>", "<Заголовок>");
